	...
	return (
		<main>
			...
			<div className="ui container">
				...
				<p>
					My collection consists of more than 300 items, ranging from
					orchestrions, coin operated pianos, antique slot machines, and
					animations, down to small bird boxes. Most of the items are
					displayed at the Musée Mécanique at Pier 45 in San Francisco,
					although I keep some of the more fragile and collectible items in my
					home.
				</p>
				<p>
					...
					and old jukeboxes. For 5 cents I bought a penny skill game that you
					put a penny in and get five balls and it goes around in a circle. I
					put pennies in it and taught my parents and my friends to do the
				...
				<p>
					When I returned from the service after World War II, I again visited
					Golden Gate Avenue. In the basement of one of the warehouses I found
					eight picture machines for $10 apiece, including delivery. These
					machines have been working ever since-first, for a penny. Then,
					later, I changed them to a nickel and they received the same amount
					of play. Later on, I changed them to a dime and the number of plays
					increased. Several years ago, I changed them to a quarter and the
					number of plays tripled.
				</p>
				<p>
					In 1946, while learning the painting business, I visited a job in
					Oakland at the Mills Novelty Company. While I was there, I noticed a
					Seeburg piano with a xylophone and mandolin attachment. I inquired
					about it and asked if they would play it for me. As soon as it
					started playing, several of the mechanics gathered around and tried
					to make it play better. I asked the manager if it was for sale and
					he said he would love to get it out of his shop because it was
					costing the company too much money to have these men play around
					with the machine. I paid $200 for the piano and had it delivered to
					my home.
				</p>
				<p>
				...
				<p>
					...
					Whitney, Sr.; we traded music boxes and pianos back and forth. I
					made one trade with George Whitney that I will never forget. I had
				...
				<p>
					Recently, I received an unsolicited offer of $250,000 for the
					motorcycle. Now I know I really got the best deal!
				</p>
				<p>
					Special thanks to the people that help keep the Musée working: Ken
